...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_message "Catalyst.Protocol.Transaction.PublicEntry" do
    optional :base, :message, 1, "Catalyst.Protocol.Transaction.BaseEntry"
  ...
  add_message "Catalyst.Protocol.Transaction.ConfidentialEntry" do
    optional :base, :message, 1, "Catalyst.Protocol.Transaction.BaseEntry"
    optional :pedersen_commitment, :bytes, 2
    optional :range_proof, :message, 3, "Catalyst.Protocol.Transaction.RangeProof"
  end
  add_message "Catalyst.Protocol.Transaction.BaseEntry" do
    optional :nonce, :uint64, 1
    optional :receiver_public_key, :bytes, 2
    optional :sender_public_key, :bytes, 3
    optional :transaction_fees, :bytes, 4
  end
...
module Catalyst
  module Protocol
    module Transaction
      ...
      BaseEntry = Google::Protobuf::DescriptorPool.generated_pool.lookup("Catalyst.Protocol.Transaction.BaseEntry").msgclass
