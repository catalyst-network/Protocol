...
_PUBLICENTRY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='base', full_name='Catalyst.Protocol.Transaction.PublicEntry.base', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='amount', full_name='Catalyst.Protocol.Transaction.PublicEntry.amount', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='data', full_name='Catalyst.Protocol.Transaction.PublicEntry.data', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='timestamp', full_name='Catalyst.Protocol.Transaction.PublicEntry.timestamp', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='signature', full_name='Catalyst.Protocol.Transaction.PublicEntry.signature', index=4,
...
_CONFIDENTIALENTRY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='base', full_name='Catalyst.Protocol.Transaction.ConfidentialEntry.base', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='pedersen_commitment', full_name='Catalyst.Protocol.Transaction.ConfidentialEntry.pedersen_commitment', index=1,
      number=2, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=_b(""),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='range_proof', full_name='Catalyst.Protocol.Transaction.ConfidentialEntry.range_proof', index=2,
...
_BASEENTRY = _descriptor.Descriptor(
  name='BaseEntry',
  full_name='Catalyst.Protocol.Transaction.BaseEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='nonce', full_name='Catalyst.Protocol.Transaction.BaseEntry.nonce', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='receiver_public_key', full_name='Catalyst.Protocol.Transaction.BaseEntry.receiver_public_key', index=1,
      number=2, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=_b(""),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='sender_public_key', full_name='Catalyst.Protocol.Transaction.BaseEntry.sender_public_key', index=2,
      number=3, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=_b(""),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='transaction_fees', full_name='Catalyst.Protocol.Transaction.BaseEntry.transaction_fees', index=3,
...
_PUBLICENTRY.fields_by_name['base'].message_type = _BASEENTRY
...
_CONFIDENTIALENTRY.fields_by_name['base'].message_type = _BASEENTRY
...
DESCRIPTOR.message_types_by_name['BaseEntry'] = _BASEENTRY
...
BaseEntry = _reflection.GeneratedProtocolMessageType('BaseEntry', (_message.Message,), dict(
  DESCRIPTOR = _BASEENTRY,
  __module__ = 'Transaction_pb2'
  # @@protoc_insertion_point(class_scope:Catalyst.Protocol.Transaction.BaseEntry)
  ))
_sym_db.RegisterMessage(BaseEntry)
