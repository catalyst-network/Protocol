...
_ERRORCODE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NO_ERROR', index=6, number=418,
      options=None,
      type=None),
  ],
  containing_type=None,
