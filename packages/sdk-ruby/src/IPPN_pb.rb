...
Google::Protobuf::DescriptorPool.generated_pool.build do
  ...
  add_message "Catalyst.Protocol.IPPN.LatestDeltaHashResponse" do
    optional :isSync, :bool, 1
    optional :deltaIndex, :message, 2, "Catalyst.Protocol.Deltas.DeltaIndex"
  end
  ...
  add_message "Catalyst.Protocol.IPPN.DeltaHistoryResponse" do
    repeated :deltaIndex, :message, 1, "Catalyst.Protocol.Deltas.DeltaIndex"
  end
end
