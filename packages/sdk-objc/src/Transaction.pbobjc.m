    ...
    static GPBMessageFieldDescription fields[] = {
      {
        ...
        .number = PublicEntry_FieldNumber_ReceiverAddress,
        .hasIndex = 0,
        .offset = (uint32_t)offsetof(PublicEntry__storage_, receiverAddress),
      ...
      },
      {
        .name = "senderAddress",
        .dataTypeSpecific.className = NULL,
        .number = PublicEntry_FieldNumber_SenderAddress,
        .hasIndex = 1,
        .offset = (uint32_t)offsetof(PublicEntry__storage_, senderAddress),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeBytes,
      },
      {
      ...
      },
      {
        ...
        .dataTypeSpecific.className = NULL,
        .number = PublicEntry_FieldNumber_TransactionFees,
        .hasIndex = 7,
        .offset = (uint32_t)offsetof(PublicEntry__storage_, transactionFees),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeBytes,
      },
      {
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        ...
        .dataTypeSpecific.className = NULL,
        .number = ConfidentialEntry_FieldNumber_ReceiverPublicKey,
        .hasIndex = 0,
        .offset = (uint32_t)offsetof(ConfidentialEntry__storage_, receiverPublicKey),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeBytes,
      },
      {
        ...
        .dataTypeSpecific.className = NULL,
        .number = ConfidentialEntry_FieldNumber_SenderPublicKey,
        .hasIndex = 1,
        .offset = (uint32_t)offsetof(ConfidentialEntry__storage_, senderPublicKey),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeBytes,
      },
      {
      ...
      },
      {
        .name = "transactionFees",
        .dataTypeSpecific.className = NULL,
        .number = ConfidentialEntry_FieldNumber_TransactionFees,
        .hasIndex = 4,
        .offset = (uint32_t)offsetof(ConfidentialEntry__storage_, transactionFees),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeBytes,
      },
      {
        .name = "nonce",
        .dataTypeSpecific.className = NULL,
        .number = ConfidentialEntry_FieldNumber_Nonce,
        .hasIndex = 5,
        .offset = (uint32_t)offsetof(ConfidentialEntry__storage_, nonce),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeUInt64,
      },
    };
