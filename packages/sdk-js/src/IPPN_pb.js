...
proto.Catalyst.Protocol.IPPN.LatestDeltaHashResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    issync: jspb.Message.getFieldWithDefault(msg, 1, false),
    deltaindex: (f = msg.getDeltaindex()) && Deltas_pb.DeltaIndex.toObject(includeInstance, f)
  };
...
/**
 * optional bool isSync = 1;
 * Note that Boolean fields may be set to 0/1 when serialized from a Java server.
 * You should avoid comparisons like {@code val === true/false} in those cases.
 * @return {boolean}
 */
proto.Catalyst.Protocol.IPPN.LatestDeltaHashResponse.prototype.getIssync = function() {
  return /** @type {boolean} */ (jspb.Message.getFieldWithDefault(this, 1, false));
};


/** @param {boolean} value */
proto.Catalyst.Protocol.IPPN.LatestDeltaHashResponse.prototype.setIssync = function(value) {
  jspb.Message.setField(this, 1, value);
};


/**
 * optional Catalyst.Protocol.Deltas.DeltaIndex deltaIndex = 2;
 * @return {?proto.Catalyst.Protocol.Deltas.DeltaIndex}
 */
proto.Catalyst.Protocol.IPPN.LatestDeltaHashResponse.prototype.getDeltaindex = function() {
  return /** @type{?proto.Catalyst.Protocol.Deltas.DeltaIndex} */ (
    jspb.Message.getWrapperField(this, Deltas_pb.DeltaIndex, 2));
};


/** @param {?proto.Catalyst.Protocol.Deltas.DeltaIndex|undefined} value */
proto.Catalyst.Protocol.IPPN.LatestDeltaHashResponse.prototype.setDeltaindex = function(value) {
  jspb.Message.setWrapperField(this, 2, value);
};


proto.Catalyst.Protocol.IPPN.LatestDeltaHashResponse.prototype.clearDeltaindex = function() {
  this.setDeltaindex(undefined);
};
 ...
 * @return {!boolean}
 */
proto.Catalyst.Protocol.IPPN.LatestDeltaHashResponse.prototype.hasDeltaindex = function() {
...
proto.Catalyst.Protocol.IPPN.DeltaHistoryResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    deltaindexList: jspb.Message.toObjectList(msg.getDeltaindexList(),
 ...
 */
proto.Catalyst.Protocol.IPPN.DeltaHistoryResponse.prototype.getDeltaindexList = function() {
...
proto.Catalyst.Protocol.IPPN.DeltaHistoryResponse.prototype.setDeltaindexList = function(value) {
  jspb.Message.setRepeatedWrapperField(this, 1, value);
};
 ...
 * @return {!proto.Catalyst.Protocol.Deltas.DeltaIndex}
 */
proto.Catalyst.Protocol.IPPN.DeltaHistoryResponse.prototype.addDeltaindex = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.Catalyst.Protocol.Deltas.DeltaIndex, opt_index);
};


proto.Catalyst.Protocol.IPPN.DeltaHistoryResponse.prototype.clearDeltaindexList = function() {
  this.setDeltaindexList([]);
};
