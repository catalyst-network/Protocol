...
impl ::protobuf::Message for DeltaIndex {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                ::protobuf::reflect::MessageDescriptor::new_pb_name::<DeltaIndex>(
                    "DeltaIndex",
                    fields,
    ...
    fn default_instance() -> &'static DeltaIndex {
        static mut instance: ::protobuf::lazy::Lazy<DeltaIndex> = ::protobuf::lazy::Lazy::INIT;
        unsafe {
...
impl Delta {
    ...
    pub fn get_delta_number(&self) -> i64 {
        self.delta_number
    }
    pub fn clear_delta_number(&mut self) {
        self.delta_number = 0;
    }

    // Param is passed by value, moved
    pub fn set_delta_number(&mut self, v: i64) {
        self.delta_number = v;
    }
...
impl ::protobuf::Message for Delta {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.delta_number != 0 {
            my_size += ::protobuf::rt::value_size(9, self.delta_number, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.gas_used != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.delta_number != 0 {
            os.write_int64(9, self.delta_number)?;
        }
        if self.gas_used != 0 {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeInt64>(
                    "delta_number",
                    |m: &Delta| { &m.delta_number },
                    |m: &mut Delta| { &mut m.delta_number },
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeInt64>(
                    "gas_used",
                    |m: &Delta| { &m.gas_used },
                    |m: &mut Delta| { &mut m.gas_used },
                ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ateRoot\x12!\n\x0cdelta_number\x18\t\x20\x01(\x03R\x0bdeltaNumber\x12\
    ...
    e\x20is\x20part\x20of\x20Catalyst.Network.Protocol.Protobuffs\x20<https:\
    //github.com/catalyst-network/protocol-protobuffs>\n\n\x20Catalyst.Netwo\
    rk.Protocol.Protobuffs\x20is\x20free\x20software:\x20you\x20can\x20redis\
    tribute\x20it\x20and/or\x20modify\n\x20it\x20under\x20the\x20terms\x20of\
    \x20the\x20GNU\x20General\x20Public\x20License\x20as\x20published\x20by\
    \n\x20the\x20Free\x20Software\x20Foundation,\x20either\x20version\x202\
    \x20of\x20the\x20License,\x20or\n\x20(at\x20your\x20option)\x20any\x20la\
    ter\x20version.\n\x20\n\x20Catalyst.Network.Protocol.Protobuffs\x20is\
    \x20distributed\x20in\x20the\x20hope\x20that\x20it\x20will\x20be\x20usef\
    ul,\n\x20but\x20WITHOUT\x20ANY\x20WARRANTY;\x20without\x20even\x20the\
    \x20implied\x20warranty\x20of\n\x20MERCHANTABILITY\x20or\x20FITNESS\x20F\
    OR\x20A\x20PARTICULAR\x20PURPOSE.\x20See\x20the\n\x20GNU\x20General\x20P\
    ublic\x20License\x20for\x20more\x20details.\n\x20\n\x20You\x20should\x20\
    have\x20received\x20a\x20copy\x20of\x20the\x20GNU\x20General\x20Public\
    \x20License\n\x20along\x20with\x20Catalyst.Network.Protocol.Protobuffs\
    \x20If\x20not,\x20see\x20<https://www.gnu.org/licenses/>.\n\n\x08\n\x01\
    ...
    \x01\x12\x03\x1e\x08\x16\n\r\n\x05\x04\0\x02\x01\x04\x12\x04\x1e\x08\x1d\
    \x1a\n\x0c\n\x05\x04\0\x02\x01\x05\x12\x03\x1e\x08\r\n\x0c\n\x05\x04\0\
    \x02\x01\x01\x12\x03\x1e\x0e\x11\n\x0c\n\x05\x04\0\x02\x01\x03\x12\x03\
    \x1e\x14\x15\n\n\n\x02\x04\x01\x12\x04!\0,\x01\n\n\n\x03\x04\x01\x01\x12\
    \x03!\x08\r\nH\n\x04\x04\x01\x02\0\x12\x03\"\x08*\";\x20\x20address\x20f\
    or\x20the\x20content\x20of\x20the\x20previous\x20delta\x20on\x20the\x20D\
    FS\n\n\r\n\x05\x04\x01\x02\0\x04\x12\x04\"\x08!\x0f\n\x0c\n\x05\x04\x01\
    \x02\0\x05\x12\x03\"\x08\r\n\x0c\n\x05\x04\x01\x02\0\x01\x12\x03\"\x0e%\
    \n\x0c\n\x05\x04\x01\x02\0\x03\x12\x03\"()\n\x0b\n\x04\x04\x01\x02\x01\
    \x12\x03#\x08\x1e\n\r\n\x05\x04\x01\x02\x01\x04\x12\x04#\x08\"*\n\x0c\n\
    \x05\x04\x01\x02\x01\x05\x12\x03#\x08\r\n\x0c\n\x05\x04\x01\x02\x01\x01\
    \x12\x03#\x0e\x19\n\x0c\n\x05\x04\x01\x02\x01\x03\x12\x03#\x1c\x1d\n=\n\
    \x04\x04\x01\x02\x02\x12\x03$\x08\x1e\"0\x20proof\x20of\x20delegated\x20\
    authority\x20for\x20active\x20wokers\n\n\r\n\x05\x04\x01\x02\x02\x04\x12\
    ...
    \x02\x06\x12\x03(\x08@\"\x17\x20one\x20per\x20active\x20worker\n\n\x0c\n\
    ...
    \x08\x1d\"\x1c\x20the\x20hash\x20of\x20the\x20state\x20root\n\n\r\n\x05\
    \x04\x01\x02\x07\x04\x12\x04)\x08(@\n\x0c\n\x05\x04\x01\x02\x07\x05\x12\
    \x03)\x08\r\n\x0c\n\x05\x04\x01\x02\x07\x01\x12\x03)\x0e\x18\n\x0c\n\x05\
    \x04\x01\x02\x07\x03\x12\x03)\x1b\x1c\n+\n\x04\x04\x01\x02\x08\x12\x03*\
    \x08\x1f\"\x1e\x20the\x20consecutive\x20delta\x20number\n\n\r\n\x05\x04\
    \x01\x02\x08\x04\x12\x04*\x08)\x1d\n\x0c\n\x05\x04\x01\x02\x08\x05\x12\
    \x03*\x08\r\n\x0c\n\x05\x04\x01\x02\x08\x01\x12\x03*\x0e\x1a\n\x0c\n\x05\
    \x04\x01\x02\x08\x03\x12\x03*\x1d\x1e\n(\n\x04\x04\x01\x02\t\x12\x03+\
    \x08\x1c\"\x1b\x20the\x20gas\x20used\x20in\x20the\x20delta\n\n\r\n\x05\
    \x04\x01\x02\t\x04\x12\x04+\x08*\x1f\n\x0c\n\x05\x04\x01\x02\t\x05\x12\
    \x03+\x08\r\n\x0c\n\x05\x04\x01\x02\t\x01\x12\x03+\x0e\x16\n\x0c\n\x05\
    \x04\x01\x02\t\x03\x12\x03+\x19\x1bb\x06proto3\
";
