...
impl ::protobuf::Message for Signature {
    ...
    fn default_instance() -> &'static Signature {
        static mut instance: ::protobuf::lazy::Lazy<Signature> = ::protobuf::lazy::Lazy::INIT;
        unsafe {
...
impl ::protobuf::Message for SigningContext {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                ::protobuf::reflect::MessageDescriptor::new_pb_name::<SigningContext>(
                    "SigningContext",
                    fields,
                    file_descriptor_proto()
                )
    ...
    fn default_instance() -> &'static SigningContext {
        static mut instance: ::protobuf::lazy::Lazy<SigningContext> = ::protobuf::lazy::Lazy::INIT;
        unsafe {
...
impl ::protobuf::Message for SignatureBatch {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                ::protobuf::reflect::MessageDescriptor::new_pb_name::<SignatureBatch>(
                    "SignatureBatch",
                    fields,
                    file_descriptor_proto()
                )
    ...
    fn default_instance() -> &'static SignatureBatch {
        static mut instance: ::protobuf::lazy::Lazy<SignatureBatch> = ::protobuf::lazy::Lazy::INIT;
        unsafe {
...
impl ::protobuf::ProtobufEnum for SignatureType {
    ...
    fn enum_descriptor_static() -> &'static ::protobuf::reflect::EnumDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ::protobuf::reflect::EnumDescriptor::new_pb_name::<SignatureType>("SignatureType", file_descriptor_proto())
            })
        }
    }
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x08+\"\x18\x20system\x20domain\x20context.\n\n\r\n\x05\x04\0\x02\0\x04\
    \x12\x04\x1c\x08\x1b\x13\n\x0c\n\x05\x04\0\x02\0\x06\x12\x03\x1c\x08\x16\
    \n\x0c\n\x05\x04\0\x02\0\x01\x12\x03\x1c\x17&\n\x0c\n\x05\x04\0\x02\0\
    \x03\x12\x03\x1c)*\n\x20\n\x04\x04\0\x02\x01\x12\x03\x1d\x08\x1c\"\x13\
    \x20signature\x20digest.\n\n\r\n\x05\x04\0\x02\x01\x04\x12\x04\x1d\x08\
    \x1c+\n\x0c\n\x05\x04\0\x02\x01\x05\x12\x03\x1d\x08\r\n\x0c\n\x05\x04\0\
    \x02\x01\x01\x12\x03\x1d\x0e\x17\n\x0c\n\x05\x04\0\x02\x01\x03\x12\x03\
    \x1d\x1a\x1b\n+\n\x02\x05\0\x12\x04!\0(\x01\x1a\x1f\x20Represents\x20dom\
    ains\x20of\x20a\x20node.\n\n\n\n\x03\x05\0\x01\x12\x03!\x05\x12\n!\n\x04\
    \x05\0\x02\0\x12\x03\"\x08#\"\x14\x20Unknown\x20signature.\n\n\x0c\n\x05\
    \x05\0\x02\0\x01\x12\x03\"\x08\x1e\n\x0c\n\x05\x05\0\x02\0\x02\x12\x03\"\
    !\"\n2\n\x04\x05\0\x02\x01\x12\x03#\x08\x1f\"%\x20Signatures\x20for\x20p\
    ublic\x20transactions.\n\n\x0c\n\x05\x05\0\x02\x01\x01\x12\x03#\x08\x1a\
    \n\x0c\n\x05\x05\0\x02\x01\x02\x12\x03#\x1d\x1e\n8\n\x04\x05\0\x02\x02\
    \x12\x03$\x08%\"+\x20Signatures\x20for\x20confidential\x20transactions.\
    \n\n\x0c\n\x05\x05\0\x02\x02\x01\x12\x03$\x08\x20\n\x0c\n\x05\x05\0\x02\
    \x02\x02\x12\x03$#$\n+\n\x04\x05\0\x02\x03\x12\x03%\x08\x19\"\x1e\x20Sig\
    natures\x20for\x20rpc\x20messages.\n\n\x0c\n\x05\x05\0\x02\x03\x01\x12\
    \x03%\x08\x14\n\x0c\n\x05\x05\0\x02\x03\x02\x12\x03%\x17\x18\n5\n\x04\
    \x05\0\x02\x04\x12\x03&\x08\x1a\"(\x20Signatures\x20for\x20peer\x20proto\
    col\x20messages.\n\n\x0c\n\x05\x05\0\x02\x04\x01\x12\x03&\x08\x15\n\x0c\
    \n\x05\x05\0\x02\x04\x02\x12\x03&\x18\x19\n<\n\x04\x05\0\x02\x05\x12\x03\
    '\x08\x19\"/\x20Signatures\x20for\x20messages\x20in\x20the\x20wen3\x20pr\
    ovider.\n\n\x0c\n\x05\x05\0\x02\x05\x01\x12\x03'\x08\x14\n\x0c\n\x05\x05\
    \0\x02\x05\x02\x12\x03'\x17\x18\n\n\n\x02\x04\x01\x12\x04*\0-\x01\n\n\n\
    \x03\x04\x01\x01\x12\x03*\x08\x16\n9\n\x04\x04\x01\x02\0\x12\x03+\x08-\"\
    ,\x20is\x20the\x20network\x20enum\x20(mainet\x20/\x20devnet\x20etc).\n\n\
    \r\n\x05\x04\x01\x02\0\x04\x12\x04+\x08*\x18\n\x0c\n\x05\x04\x01\x02\0\
    \x06\x12\x03+\x08\x1b\n\x0c\n\x05\x04\x01\x02\0\x01\x12\x03+\x1c(\n\x0c\
    \n\x05\x04\x01\x02\0\x03\x12\x03++,\na\n\x04\x04\x01\x02\x01\x12\x03,\
    \x08)\"T\x20contains\x20info\x20on\x20whether\x20the\x20signature\x20is\
    \x20for\x20a\x20protocol\x20message\x20or\x20a\x20transaction.\n\n\r\n\
    ...
    \x08\x1f\"\x10\x20Unknown\x20error.\n\n\x0c\n\x05\x05\x01\x02\0\x01\x12\
    \x030\x08\x1a\n\x0c\n\x05\x05\x01\x02\0\x02\x12\x030\x1d\x1e\nX\n\x04\
    \x05\x01\x02\x01\x12\x031\x08\x1e\"K\x20Signature\x20is\x20of\x20incorre\
    ct\x20length\x20or\x20does\x20not\x20correspond\x20to\x20a\x20valid\x20p\
    oint.\n\n\x0c\n\x05\x05\x01\x02\x01\x01\x12\x031\x08\x19\n\x0c\n\x05\x05\
    \x01\x02\x01\x02\x12\x031\x1c\x1d\n\\\n\x04\x05\x01\x02\x02\x12\x032\x08\
    \x1f\"O\x20Public\x20key\x20is\x20of\x20incorrect\x20length\x20or\x20can\
    not\x20be\x20decompressed\x20to\x20a\x20valid\x20point.\n\n\x0c\n\x05\
    \x05\x01\x02\x02\x01\x12\x032\x08\x1a\n\x0c\n\x05\x05\x01\x02\x02\x02\
    \x12\x032\x1d\x1e\n2\n\x04\x05\x01\x02\x03\x12\x033\x08\x20\"%\x20Privat\
    e\x20key\x20is\x20of\x20incorrect\x20length.\n\n\x0c\n\x05\x05\x01\x02\
    \x03\x01\x12\x033\x08\x1b\n\x0c\n\x05\x05\x01\x02\x03\x02\x12\x033\x1e\
    \x1f\nM\n\x04\x05\x01\x02\x04\x12\x034\x02%\"@\x20Signature\x20cannot\
    \x20be\x20verified\x20against\x20the\x20provided\x20information.\n\n\x0c\
    \n\x05\x05\x01\x02\x04\x01\x12\x034\x02\x20\n\x0c\n\x05\x05\x01\x02\x04\
    \x02\x12\x034#$\n9\n\x04\x05\x01\x02\x05\x12\x035\x02\x1d\",\x20Context\
    \x20exceed\x20the\x20maximum\x20allowed\x20length.\n\n\x0c\n\x05\x05\x01\
    \x02\x05\x01\x12\x035\x02\x18\n\x0c\n\x05\x05\x01\x02\x05\x02\x12\x035\
    \x1b\x1c\n8\n\x04\x05\x01\x02\x06\x12\x036\x08\"\"+\x20Unable\x20to\x20c\
    onvert\x20message\x20to\x20valid\x20data.\x20\n\n\x0c\n\x05\x05\x01\x02\
    \x06\x01\x12\x036\x08\x1d\n\x0c\n\x05\x05\x01\x02\x06\x02\x12\x036\x20!\
    \np\n\x04\x05\x01\x02\x07\x12\x037\x08$\"c\x20Cannot\x20perform\x20batch\
    \x20verification\x20as\x20an\x20unequal\x20number\x20of\x20messages/sign\
    atures/keys\x20were\x20provided.\n\n\x0c\n\x05\x05\x01\x02\x07\x01\x12\
    \x037\x08\x1f\n\x0c\n\x05\x05\x01\x02\x07\x02\x12\x037\"#\n9\n\x04\x05\
    \x01\x02\x08\x12\x038\x08'\",\x20One\x20or\x20more\x20signatures\x20cann\
    ot\x20be\x20verified.\n\n\x0c\n\x05\x05\x01\x02\x08\x01\x12\x038\x08\"\n\
    \x0c\n\x05\x05\x01\x02\x08\x02\x12\x038%&\n(\n\x04\x05\x01\x02\t\x12\x03\
    9\x08\x17\"\x1b\x20No\x20error\x20(just\x20a\x20teapot).\n\n\x0c\n\x05\
    \x05\x01\x02\t\x01\x12\x039\x08\x10\n\x0c\n\x05\x05\x01\x02\t\x02\x12\
    \x039\x13\x16\n=\n\x02\x04\x02\x12\x04=\0B\x01\x1a1Holds\x20data\x20for\
    \x20batch\x20verification\x20of\x20signatures.\n\n\n\n\x03\x04\x02\x01\
