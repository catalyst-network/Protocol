...
impl ::protobuf::Message for PublicEntry {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.gas_price.is_empty() {
            my_size += ::protobuf::rt::bytes_size(5, &self.gas_price);
        }
        if self.gas_limit != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if !self.gas_price.is_empty() {
            os.write_bytes(5, &self.gas_price)?;
        }
        if self.gas_limit != 0 {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                ::protobuf::reflect::MessageDescriptor::new_pb_name::<PublicEntry>(
                    "PublicEntry",
                    fields,
    ...
    fn default_instance() -> &'static PublicEntry {
        static mut instance: ::protobuf::lazy::Lazy<PublicEntry> = ::protobuf::lazy::Lazy::INIT;
        unsafe {
...
impl ::protobuf::Message for ConfidentialEntry {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                ::protobuf::reflect::MessageDescriptor::new_pb_name::<ConfidentialEntry>(
                    "ConfidentialEntry",
                    fields,
                    file_descriptor_proto()
                )
    ...
    fn default_instance() -> &'static ConfidentialEntry {
        static mut instance: ::protobuf::lazy::Lazy<ConfidentialEntry> = ::protobuf::lazy::Lazy::INIT;
        unsafe {
...
impl ::protobuf::Message for CoinbaseEntry {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                ::protobuf::reflect::MessageDescriptor::new_pb_name::<CoinbaseEntry>(
                    "CoinbaseEntry",
                    fields,
                    file_descriptor_proto()
                )
    ...
    fn default_instance() -> &'static CoinbaseEntry {
        static mut instance: ::protobuf::lazy::Lazy<CoinbaseEntry> = ::protobuf::lazy::Lazy::INIT;
        unsafe {
...
impl ::protobuf::Message for RangeProof {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                ::protobuf::reflect::MessageDescriptor::new_pb_name::<RangeProof>(
                    "RangeProof",
                    fields,
                    file_descriptor_proto()
                )
    ...
    fn default_instance() -> &'static RangeProof {
        static mut instance: ::protobuf::lazy::Lazy<RangeProof> = ::protobuf::lazy::Lazy::INIT;
        unsafe {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    tography.proto\"\xa4\x02\n\x0bPublicEntry\x12)\n\x10receiver_address\x18\
    \x01\x20\x01(\x0cR\x0freceiverAddress\x12%\n\x0esender_address\x18\x02\
    \x20\x01(\x0cR\rsenderAddress\x12\x16\n\x06amount\x18\x03\x20\x01(\x0cR\
    \x06amount\x12\x12\n\x04data\x18\x04\x20\x01(\x0cR\x04data\x12\x1b\n\tga\
    s_price\x18\x05\x20\x01(\x0cR\x08gasPrice\x12\x1b\n\tgas_limit\x18\x06\
    \x20\x01(\x04R\x08gasLimit\x12\x14\n\x05nonce\x18\x07\x20\x01(\x04R\x05n\
    once\x12G\n\tsignature\x18\x08\x20\x01(\x0b2).Catalyst.Protocol.Cryptogr\
    aphy.SignatureR\tsignature\"\xad\x02\n\x11ConfidentialEntry\x12.\n\x13re\
    ceiver_public_key\x18\x01\x20\x01(\x0cR\x11receiverPublicKey\x12*\n\x11s\
    ender_public_key\x18\x02\x20\x01(\x0cR\x0fsenderPublicKey\x12/\n\x13pede\
    rsen_commitment\x18\x03\x20\x01(\x0cR\x12pedersenCommitment\x12J\n\x0bra\
    nge_proof\x18\x04\x20\x01(\x0b2).Catalyst.Protocol.Transaction.RangeProo\
    fR\nrangeProof\x12)\n\x10transaction_fees\x18\x05\x20\x01(\x0cR\x0ftrans\
    actionFees\x12\x14\n\x05nonce\x18\x06\x20\x01(\x04R\x05nonce\"W\n\rCoinb\
    aseEntry\x12.\n\x13receiver_public_key\x18\x01\x20\x01(\x0cR\x11receiver\
    ...
    \x12\x04\x1b\0\x1f\x01\n\n\n\x03\x05\0\x01\x12\x03\x1b\x05\x14\n'\n\x04\
    \x05\0\x02\0\x12\x03\x1c\x08%\"\x1aUnknown\x20transaction\x20type.\n\n\
    \x0c\n\x05\x05\0\x02\0\x01\x12\x03\x1c\x08\x20\n\x0c\n\x05\x05\0\x02\0\
    \x02\x12\x03\x1c#$\n'\n\x04\x05\0\x02\x01\x12\x03\x1d\x08\x13\"\x1a\x20P\
    ublic\x20transaction\x20type.\n\n\x0c\n\x05\x05\0\x02\x01\x01\x12\x03\
    \x1d\x08\x0e\n\x0c\n\x05\x05\0\x02\x01\x02\x12\x03\x1d\x11\x12\n(\n\x04\
    \x05\0\x02\x02\x12\x03\x1e\x08\x19\"\x1b\x20Private\x20transaction\x20ty\
    pe.\n\n\x0c\n\x05\x05\0\x02\x02\x01\x12\x03\x1e\x08\x14\n\x0c\n\x05\x05\
    \0\x02\x02\x02\x12\x03\x1e\x17\x18\n\n\n\x02\x04\0\x12\x04!\0*\x01\n\n\n\
    ...
    \x03$\x02\x13\"\x10\x20uint256\x20amount\n\n\r\n\x05\x04\0\x02\x02\x04\
    \x12\x04$\x02#!\n\x0c\n\x05\x04\0\x02\x02\x05\x12\x03$\x02\x07\n\x0c\n\
    \x05\x04\0\x02\x02\x01\x12\x03$\x08\x0e\n\x0c\n\x05\x04\0\x02\x02\x03\
    \x12\x03$\x11\x12\n#\n\x04\x04\0\x02\x03\x12\x03%\x02\x11\"\x16\x20Smart\
    ...
    \x01\x02\x03\x12\x030\x02\x1d\n\r\n\x05\x04\x01\x02\x03\x04\x12\x040\x02\
    /\x20\n\x0c\n\x05\x04\x01\x02\x03\x06\x12\x030\x02\x0c\n\x0c\n\x05\x04\
    \x01\x02\x03\x01\x12\x030\r\x18\n\x0c\n\x05\x04\x01\x02\x03\x03\x12\x030\
    \x1b\x1c\n0\n\x04\x04\x01\x02\x04\x12\x031\x08#\"#\x208\x20bytes,\x20cle\
    ar\x20text,\x20fees\x20*\x2010^12\n\n\r\n\x05\x04\x01\x02\x04\x04\x12\
    \x041\x080\x1d\n\x0c\n\x05\x04\x01\x02\x04\x05\x12\x031\x08\r\n\x0c\n\
    \x05\x04\x01\x02\x04\x01\x12\x031\x0e\x1e\n\x0c\n\x05\x04\x01\x02\x04\
    \x03\x12\x031!\"\ns\n\x04\x04\x01\x02\x05\x12\x032\x08\x19\"f\x20A\x20no\
    nce,\x20similar\x20to\x20Ethereum,\x20incremented\x20on\x20each\x20trans\
    action\x20on\x20the\x20account\x20issuing\x20the\x20transaction\n\n\r\n\
    \x05\x04\x01\x02\x05\x04\x12\x042\x081#\n\x0c\n\x05\x04\x01\x02\x05\x05\
    \x12\x032\x08\x0e\n\x0c\n\x05\x04\x01\x02\x05\x01\x12\x032\x0f\x14\n\x0c\
    \n\x05\x04\x01\x02\x05\x03\x12\x032\x17\x18\n\n\n\x02\x04\x02\x12\x045\0\
    8\x01\n\n\n\x03\x04\x02\x01\x12\x035\x08\x15\nP\n\x04\x04\x02\x02\0\x12\
    \x036\x04\"\"C\x20public\x20key\x20behind\x20the\x20address\x20where\x20\
    the\x20Coinbase\x20will\x20be\x20credited\n\n\r\n\x05\x04\x02\x02\0\x04\
    \x12\x046\x045\x17\n\x0c\n\x05\x04\x02\x02\0\x05\x12\x036\x04\t\n\x0c\n\
    \x05\x04\x02\x02\0\x01\x12\x036\n\x1d\n\x0c\n\x05\x04\x02\x02\0\x03\x12\
    \x036\x20!\n\x1d\n\x04\x04\x02\x02\x01\x12\x037\x04\x15\"\x10\x20uint256\
    \x20amount\n\n\r\n\x05\x04\x02\x02\x01\x04\x12\x047\x046\"\n\x0c\n\x05\
    \x04\x02\x02\x01\x05\x12\x037\x04\t\n\x0c\n\x05\x04\x02\x02\x01\x01\x12\
    ...
    \x03\x02\n\x03\x12\x03I\x1a\x1c\n\x0b\n\x04\x04\x03\x02\x0b\x12\x03J\x08\
    \x15\n\r\n\x05\x04\x03\x02\x0b\x04\x12\x04J\x08I\x1d\n\x0c\n\x05\x04\x03\
    \x02\x0b\x05\x12\x03J\x08\r\n\x0c\n\x05\x04\x03\x02\x0b\x01\x12\x03J\x0e\
    \x0f\n\x0c\n\x05\x04\x03\x02\x0b\x03\x12\x03J\x12\x14b\x06proto3\
";
