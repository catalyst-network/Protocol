...
class LatestDeltaHashResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Catalyst.Protocol.IPPN.LatestDeltaHashResponse) */ {
 public:
  ...
  bool has_deltaindex() const;
  void clear_deltaindex();
  static const int kDeltaIndexFieldNumber = 2;
  const ::Catalyst::Protocol::Deltas::DeltaIndex& deltaindex() const;
  ::Catalyst::Protocol::Deltas::DeltaIndex* mutable_deltaindex();
  ::Catalyst::Protocol::Deltas::DeltaIndex* release_deltaindex();
  void set_allocated_deltaindex(::Catalyst::Protocol::Deltas::DeltaIndex* deltaindex);

  // bool isSync = 1;
  void clear_issync();
  static const int kIsSyncFieldNumber = 1;
  bool issync() const;
 ...
 private:
  ...
  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::Catalyst::Protocol::Deltas::DeltaIndex* deltaindex_;
  bool issync_;
  mutable int _cached_size_;
  friend struct  protobuf_IPPN_2eproto::TableStruct;
};
...
class DeltaHistoryResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Catalyst.Protocol.IPPN.DeltaHistoryResponse) */ {
 public:
  ...
  int deltaindex_size() const;
  void clear_deltaindex();
  static const int kDeltaIndexFieldNumber = 1;
  const ::Catalyst::Protocol::Deltas::DeltaIndex& deltaindex(int index) const;
  ::Catalyst::Protocol::Deltas::DeltaIndex* mutable_deltaindex(int index);
  ::Catalyst::Protocol::Deltas::DeltaIndex* add_deltaindex();
 ...
 private:
  ...
  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::RepeatedPtrField< ::Catalyst::Protocol::Deltas::DeltaIndex > deltaindex_;
  mutable int _cached_size_;
  friend struct  protobuf_IPPN_2eproto::TableStruct;
};
// ===================================================================
...
// bool isSync = 1;
inline void LatestDeltaHashResponse::clear_issync() {
  issync_ = false;
}
inline bool LatestDeltaHashResponse::issync() const {
  // @@protoc_insertion_point(field_get:Catalyst.Protocol.IPPN.LatestDeltaHashResponse.isSync)
  return issync_;
}
inline void LatestDeltaHashResponse::set_issync(bool value) {
...
// .Catalyst.Protocol.Deltas.DeltaIndex deltaIndex = 2;
inline bool LatestDeltaHashResponse::has_deltaindex() const {
  return this != internal_default_instance() && deltaindex_ != NULL;
}
inline void LatestDeltaHashResponse::clear_deltaindex() {
  if (GetArenaNoVirtual() == NULL && deltaindex_ != NULL) delete deltaindex_;
  deltaindex_ = NULL;
}
inline const ::Catalyst::Protocol::Deltas::DeltaIndex& LatestDeltaHashResponse::deltaindex() const {
...
inline ::Catalyst::Protocol::Deltas::DeltaIndex* LatestDeltaHashResponse::mutable_deltaindex() {
...
inline ::Catalyst::Protocol::Deltas::DeltaIndex* LatestDeltaHashResponse::release_deltaindex() {
...
inline void LatestDeltaHashResponse::set_allocated_deltaindex(::Catalyst::Protocol::Deltas::DeltaIndex* deltaindex) {
  delete deltaindex_;
...
// repeated .Catalyst.Protocol.Deltas.DeltaIndex deltaIndex = 1;
inline int DeltaHistoryResponse::deltaindex_size() const {
  return deltaindex_.size();
}
inline void DeltaHistoryResponse::clear_deltaindex() {
  deltaindex_.Clear();
}
inline const ::Catalyst::Protocol::Deltas::DeltaIndex& DeltaHistoryResponse::deltaindex(int index) const {
  // @@protoc_insertion_point(field_get:Catalyst.Protocol.IPPN.DeltaHistoryResponse.deltaIndex)
  return deltaindex_.Get(index);
}
inline ::Catalyst::Protocol::Deltas::DeltaIndex* DeltaHistoryResponse::mutable_deltaindex(int index) {
...
inline ::Catalyst::Protocol::Deltas::DeltaIndex* DeltaHistoryResponse::add_deltaindex() {
