...
class LatestDeltaHashResponse :
 ...
 public:
  ...
  private:
  const std::string& _internal_delta_hash() const;
  void _internal_set_delta_hash(const std::string& value);
  std::string* _internal_mutable_delta_hash();
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::InternalMetadataWithArena _internal_metadata_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr delta_hash_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_IPPN_2eproto;
};
// -------------------------------------------------------------------
...
inline std::string* LatestDeltaHashResponse::mutable_delta_hash() {
  ...
  return _internal_mutable_delta_hash();
}
inline const std::string& LatestDeltaHashResponse::_internal_delta_hash() const {
  return delta_hash_.GetNoArena();
}
inline void LatestDeltaHashResponse::_internal_set_delta_hash(const std::string& value) {
  
  delta_hash_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
...
inline void LatestDeltaHashResponse::set_delta_hash(const char* value) {
  ...
  delta_hash_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
...
inline void LatestDeltaHashResponse::set_delta_hash(const void* value, size_t size) {
  ...
  delta_hash_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:Catalyst.Protocol.IPPN.LatestDeltaHashResponse.delta_hash)
}
inline std::string* LatestDeltaHashResponse::_internal_mutable_delta_hash() {
  
  return delta_hash_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* LatestDeltaHashResponse::release_delta_hash() {
  ...
  return delta_hash_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void LatestDeltaHashResponse::set_allocated_delta_hash(std::string* delta_hash) {
  if (delta_hash != nullptr) {
    
  } else {
    
  }
  delta_hash_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), delta_hash);
