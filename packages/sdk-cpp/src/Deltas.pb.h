...
class Delta :
 ...
 public:
  ...
  ::PROTOBUF_NAMESPACE_ID::int64 delta_number() const;
  void set_delta_number(::PROTOBUF_NAMESPACE_ID::int64 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int64 _internal_delta_number() const;
  void _internal_set_delta_number(::PROTOBUF_NAMESPACE_ID::int64 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::int64 delta_number_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_Deltas_2eproto;
};
// ===================================================================
...
inline ::PROTOBUF_NAMESPACE_ID::int64 Delta::_internal_delta_number() const {
  return delta_number_;
}
inline ::PROTOBUF_NAMESPACE_ID::int64 Delta::delta_number() const {
  // @@protoc_insertion_point(field_get:Catalyst.Protocol.Deltas.Delta.delta_number)
  return _internal_delta_number();
}
inline void Delta::_internal_set_delta_number(::PROTOBUF_NAMESPACE_ID::int64 value) {
  
  delta_number_ = value;
}
inline void Delta::set_delta_number(::PROTOBUF_NAMESPACE_ID::int64 value) {
  _internal_set_delta_number(value);
