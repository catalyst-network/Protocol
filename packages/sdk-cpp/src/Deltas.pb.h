...
class Delta : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Catalyst.Protocol.Deltas.Delta) */ {
 public:
  ...
  void clear_delta_number();
  static const int kDeltaNumberFieldNumber = 9;
  ::google::protobuf::int64 delta_number() const;
  void set_delta_number(::google::protobuf::int64 value);

  // int64 gas_used = 10;
  void clear_gas_used();
  static const int kGasUsedFieldNumber = 10;
 ...
 private:
  ...
  ::google::protobuf::int64 delta_number_;
...
// int64 delta_number = 9;
inline void Delta::clear_delta_number() {
  delta_number_ = GOOGLE_LONGLONG(0);
}
inline ::google::protobuf::int64 Delta::delta_number() const {
  // @@protoc_insertion_point(field_get:Catalyst.Protocol.Deltas.Delta.delta_number)
  return delta_number_;
}
inline void Delta::set_delta_number(::google::protobuf::int64 value) {
...
// int64 gas_used = 10;
inline void Delta::clear_gas_used() {
  gas_used_ = GOOGLE_LONGLONG(0);
}
inline ::google::protobuf::int64 Delta::gas_used() const {
  // @@protoc_insertion_point(field_get:Catalyst.Protocol.Deltas.Delta.gas_used)
  return gas_used_;
}
inline void Delta::set_gas_used(::google::protobuf::int64 value) {
