...
const ::google::protobuf::uint32 TableStruct::offsets[] = {
  ...
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Delta, delta_number_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Delta, gas_used_),
};
...
const int Delta::kDeltaNumberFieldNumber;
const int Delta::kGasUsedFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900
...
Delta::Delta(const Delta& from)
  ...
  ::memcpy(&delta_number_, &from.delta_number_,
    reinterpret_cast<char*>(&gas_used_) -
    reinterpret_cast<char*>(&delta_number_) + sizeof(gas_used_));
...
void Delta::SharedCtor() {
  ...
  merkle_poda_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  state_root_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  ::memset(&time_stamp_, 0, reinterpret_cast<char*>(&gas_used_) -
    reinterpret_cast<char*>(&time_stamp_) + sizeof(gas_used_));
  _cached_size_ = 0;
}
...
// @@protoc_insertion_point(message_clear_start:Catalyst.Protocol.Deltas.Delta)
  ...
  time_stamp_ = NULL;
  ::memset(&delta_number_, 0, reinterpret_cast<char*>(&gas_used_) -
    reinterpret_cast<char*>(&delta_number_) + sizeof(gas_used_));
}
...
void Delta::SerializeWithCachedSizes(
  ...
  if (this->delta_number() != 0) {
    ::google::protobuf::internal::WireFormatLite::WriteInt64(9, this->delta_number(), output);
  }

  // int64 gas_used = 10;
  if (this->gas_used() != 0) {
    ::google::protobuf::internal::WireFormatLite::WriteInt64(10, this->gas_used(), output);
  }
...
::google::protobuf::uint8* Delta::InternalSerializeWithCachedSizesToArray(
  ...
  // int64 delta_number = 9;
  if (this->delta_number() != 0) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt64ToArray(9, this->delta_number(), target);
  }

  // int64 gas_used = 10;
  if (this->gas_used() != 0) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt64ToArray(10, this->gas_used(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:Catalyst.Protocol.Deltas.Delta)
  ...
  if (from.delta_number() != 0) {
    set_delta_number(from.delta_number());
  }
  if (from.gas_used() != 0) {
...
void Delta::InternalSwap(Delta* other) {
  ...
  std::swap(delta_number_, other->delta_number_);
...
// int64 delta_number = 9;
void Delta::clear_delta_number() {
  delta_number_ = GOOGLE_LONGLONG(0);
}
::google::protobuf::int64 Delta::delta_number() const {
  // @@protoc_insertion_point(field_get:Catalyst.Protocol.Deltas.Delta.delta_number)
  return delta_number_;
}
void Delta::set_delta_number(::google::protobuf::int64 value) {
  
  delta_number_ = value;
  // @@protoc_insertion_point(field_set:Catalyst.Protocol.Deltas.Delta.delta_number)
}

// int64 gas_used = 10;
void Delta::clear_gas_used() {
  gas_used_ = GOOGLE_LONGLONG(0);
}
::google::protobuf::int64 Delta::gas_used() const {
  // @@protoc_insertion_point(field_get:Catalyst.Protocol.Deltas.Delta.gas_used)
  return gas_used_;
}
void Delta::set_gas_used(::google::protobuf::int64 value) {
  
  gas_used_ = value;
  // @@protoc_insertion_point(field_set:Catalyst.Protocol.Deltas.Delta.gas_used)
}
